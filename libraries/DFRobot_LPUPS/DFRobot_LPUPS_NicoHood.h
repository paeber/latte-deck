/*!
 * @file  DFRobot_LPUPS_NicoHood.h
 * @brief  NicoHood-compatible version of DFRobot_LPUPS class
 * @details  Modified to work with NicoHood HID library without conflicts
 ...
 */
#ifndef __DFRobot_LPUPS_Nicohood_H__
#define __DFRobot_LPUPS_Nicohood_H__
...
/************************ Init ********************************/
  /**
   * @fn DFRobot_LPUPS_NicoHood
   * @brief Constructor
   * @return None
   */
  DFRobot_LPUPS_NicoHood(void);

  /**
   * @fn begin
   * @brief Init function - I2C communication only, no HID
...
class DFRobot_LPUPS_I2C_NicoHood:public DFRobot_LPUPS_NicoHood
{
public:
  /**
   * @fn DFRobot_LPUPS_I2C_NicoHood
   ...
   * @return None
   */
  DFRobot_LPUPS_I2C_NicoHood(TwoWire *pWire=&Wire, uint8_t i2cAddr=UPS_I2C_ADDRESS);

  /**
   * @fn begin
   * @brief Subclass init function - I2C communication only, no HID
   * @param upsType What type of ups
   * @return int type, indicates returning init status
   * @retval 0 NO_ERROR
   * @retval -1 ERR_DATA_BUS
